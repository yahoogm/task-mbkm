  ...
  let days = time / (1000 * 3600 * 24);
	...
	return `<div class='feed bg-white border-2 rounded-md drop-shadow-md'>
            <div class="top-bar p-2">
              <div class="on-bar flex justify-between">
                <div class="img-p flex items-center">
                  <img src="${
										feed.photo
									}" alt="ig" id="img-user" class="rounded-full drop-shadow-md shadow-black mr-2" />
                  <a href="" class="font-medium text-gray-800" id="username">${
										feed.username
									}</a>
                </div>
            ...
            <div class="likes p-2 -mt-2 text-xs">
              <span class="text-black-900 font-bold">Likes <a href="" class="text-black-900 font-bold" id="likes">${
								feed.likes
							}</a></span>
            </div>
            ...
            <div class="caption p-2 -mt-2">
              <div class="content-caption flex space-x-1">
                <div class="content-text break-words">
                  <a href=""><span class="text-black-900 font-bold mr-1" id="username">${
										feed.username
									}
                  </span></a>
